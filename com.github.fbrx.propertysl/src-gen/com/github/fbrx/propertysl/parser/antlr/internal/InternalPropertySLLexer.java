...
public class InternalPropertySLLexer extends Lexer {
    ...
    public final void mRULE_LOCALE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../com.github.fbrx.propertysl/src-gen/com/github/fbrx/propertysl/parser/antlr/internal/InternalPropertySL.g:670:13: ( 'a' .. 'z' 'a' .. 'z' )
            // ../com.github.fbrx.propertysl/src-gen/com/github/fbrx/propertysl/parser/antlr/internal/InternalPropertySL.g:670:15: 'a' .. 'z' 'a' .. 'z'
            {
            matchRange('a','z'); 
            matchRange('a','z'); 
